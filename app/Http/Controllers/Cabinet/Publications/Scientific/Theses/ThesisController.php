...
class ThesisController extends Controller
{
    ...
    public function index(Auth $auth)
    {
        ...
        return view('cabinet.publications.scientific.theses.index', ['theses' => $theses]);
    }
    ...
    {
        return view('cabinet.publications.scientific.theses.create')
            ->with([
    ...
    public function store(StoreRequest $request, PublicationStorageInterface $publicationStorage)
    {
        ...
        return redirect()->route('scientific.theses.index')->with('status', 'The new thesis is added!');
    }
    ...
    public function show(int $thesisId)
    {
        ...
        return view('cabinet.publications.scientific.theses.show', ['thesis' => $thesis]);
    }
    ...
    {
        return view('cabinet.publications.scientific.theses.edit')
            ->with([
                'thesis' => $thesis,
                'languages' => $languageRepository->all(),
                'publicationTypes' => $this->publicationTypeRepository->all()
    ...
    public function update(UpdateRequest $request, int $thesisId, PublicationStorageInterface $publicationStorage)
    {
        ...
        return redirect()->route('scientific.theses.show', $thesisId)->with('status', 'The thesis is updated!');
    }
    ...
    public function destroy(Thesis $thesis)
    {
        ...
        return redirect()->route('scientific.theses.index')->with('status', 'The thesis has been deleted!');
    }
