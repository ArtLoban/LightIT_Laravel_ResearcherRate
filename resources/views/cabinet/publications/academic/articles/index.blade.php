...
@section('cabinet')
    <div class="col-lg-10">
        <div class="mt-4">
            <p class="h5">Publications / Academic / <span class="publication-tipe-title">Articles</span></p>
        </div>
        @if (session('status'))
        ...
        <div class="form-group">
            <a href="{{ route('academic.articles.create') }}" class="btn btn-success">Add new article</a>
        </div>
        <hr>
        @if(! $articles->isEmpty())
                        ...
                        <table class="table text-center" cellspacing="0">
                            ...
                            @foreach($articles as $article)
                                <tr class="table">
                                    ...
                                    <td>
                                        <a href="{{ route('academic.articles.show', $article->getKey()) }}">
                                            {{ $article->name }}
                                        </a>
                                    </td>
