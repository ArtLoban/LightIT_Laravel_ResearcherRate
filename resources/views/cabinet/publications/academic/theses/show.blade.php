...
@section('cabinet')
    <div class="col-lg-10">
        <div class="mt-4">
            ...
            <a class="btn btn-outline-info" href="{{ route('academic.theses.edit', $thesis->getKey()) }}">Edit thesis</a>
        <hr>
        @if (session('status'))
            <div class="row">
        ...
        @if($thesis->file)
            <div class="form-group">
                ...
                {!! Form::open(['route' => ['academic.theses.file', $thesis->getKey()], 'method' => 'GET']) !!}
                    <button type="submit" class="btn btn-light">View file</button>
                {!! Form::close() !!}

                {!! Form::open(['route' => ['academic.theses.download', $thesis->getKey()], 'method' => 'GET']) !!}
        ...
        {!! Form::open([
            'route' => ['academic.theses.destroy', $thesis->getKey()],
            'method' => 'delete'])
        !!}
